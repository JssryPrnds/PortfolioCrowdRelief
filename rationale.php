...
<body>
    <div class="text">
        <p1>Hello, welcome to our official website!</p1>
        <h1>BSIT 3C</h1>
        <span></span>
        <p2>Bachelor of Science in Information Technology
            <br>Major in washing machine, refrigerator, and AC repair.
        </p2><br>
		<button onclick="enrollNow()">Get Started</button>
    </div>

    <div class="main-title">
        <img src='images/SK.png' alt="Logo" class="logo">
        <h1>Main Title</h1>
    </div>
        <div class="section">
            <h2>Rationale</h2>
